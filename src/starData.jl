# source: https://github.com/jdlamstein/N-body-Gravity-Simulator
"""
...
xSet = [[xSun], [xMercury], [xVenus], [xEarth], [xMars], [xJup], [xSaturn], [xUranus], [xNeptune], [xPluto]]
ySet = [[ySun], [yMercury], [yVenus], [yEarth], [yMars], [yJup], [ySaturn], [yUranus], [yNeptune], [yPluto]]
zSet = [[zSun], [zMercury], [zVenus], [zEarth], [zMars], [zJup], [zSaturn], [zUranus], [zNeptune], [zPluto]]
vxSet = [[vxSun], [vxMercury], [vxVenus], [vxEarth], [vxMars], [vxJup], [vxSaturn], [vxUranus], [vxNeptune], [vxPluto]]
vySet = [[vySun], [vyMercury], [vyVenus], [vyEarth], [vyMars], [vyJup], [vySaturn], [vyUranus], [vyNeptune], [vyPluto]]
vzSet = [[vzSun], [vzMercury], [vzVenus], [vzEarth], [vzMars], [vzJup], [vzSaturn], [vzUranus], [vzNeptune], [vzPluto]]
m = [mSun, mMercury, mVenus, mEarth, mMars, mJup, mSaturn, mUranus, mNeptune, mPluto]

# Arrays for testing if the solar system is maximally packed. 
xPacked = [[xSun], [xMercury], [xVenus], [xEarth], [xMars], [xPlanet],[xJup], [xSaturn], [xUranus], [xNeptune], [xPluto]]
yPacked = [[ySun], [yMercury], [yVenus], [yEarth], [yMars], [yPlanet], [yJup], [ySaturn], [yUranus], [yNeptune], [yPluto]]
zPacked = [[zSun], [zMercury], [zVenus], [zEarth], [zMars], [zPlanet],[zJup], [zSaturn], [zUranus], [zNeptune], [zPluto]]
vxPacked = [[vxSun], [vxMercury], [vxVenus], [vxEarth], [vxMars], [vxPlanet],[vxJup], [vxSaturn], [vxUranus], [vxNeptune], [vxPluto]]
vyPacked = [[vySun], [vyMercury], [vyVenus], [vyEarth], [vyMars], [vyPlanet],[vyJup], [vySaturn], [vyUranus], [vyNeptune], [vyPluto]]
vzPacked = [[vzSun], [vzMercury], [vzVenus], [vzEarth], [vzMars], [vzPlanet],[vzJup], [vzSaturn], [vzUranus], [vzNeptune], [vzPluto]]
mPacked = [mSun, mMercury, mVenus, mEarth, mMars, mPlanet, mJup, mSaturn, mUranus, mNeptune, mPluto]
